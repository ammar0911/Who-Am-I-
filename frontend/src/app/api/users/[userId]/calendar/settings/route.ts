...
export async function POST(
    ...
    try {
        ...
        console.error('Error saving calendars:', error instanceof Error ? error.message : String(error));
        return NextResponse.json({ error: 'Failed to save calendars' }, { status: 500 });
    }
}
